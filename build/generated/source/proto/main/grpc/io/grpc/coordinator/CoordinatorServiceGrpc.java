...
public final class CoordinatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.coordinator.Coordinator.requestrobotid,
      io.grpc.coordinator.Coordinator.responserobotid> getCoordinatorrobotreportMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "coordinatorrobotreport",
      requestType = io.grpc.coordinator.Coordinator.requestrobotid.class,
      responseType = io.grpc.coordinator.Coordinator.responserobotid.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.coordinator.Coordinator.requestrobotid,
      io.grpc.coordinator.Coordinator.responserobotid> getCoordinatorrobotreportMethod() {
    io.grpc.MethodDescriptor<io.grpc.coordinator.Coordinator.requestrobotid, io.grpc.coordinator.Coordinator.responserobotid> getCoordinatorrobotreportMethod;
      ...
      synchronized (CoordinatorServiceGrpc.class) {
        if ((getCoordinatorrobotreportMethod = CoordinatorServiceGrpc.getCoordinatorrobotreportMethod) == null) {
          CoordinatorServiceGrpc.getCoordinatorrobotreportMethod = getCoordinatorrobotreportMethod =
              io.grpc.MethodDescriptor.<io.grpc.coordinator.Coordinator.requestrobotid, io.grpc.coordinator.Coordinator.responserobotid>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "coordinatorrobotreport"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.coordinator.Coordinator.requestrobotid.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.coordinator.Coordinator.responserobotid.getDefaultInstance()))
  ...
  public static abstract class CoordinatorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void coordinatorrobotreport(io.grpc.coordinator.Coordinator.requestrobotid request,
        io.grpc.stub.StreamObserver<io.grpc.coordinator.Coordinator.responserobotid> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.coordinator.Coordinator.requestrobotid,
                io.grpc.coordinator.Coordinator.responserobotid>(
  ...
  public static final class CoordinatorServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CoordinatorServiceBlockingStub> {
    ...
    /**
     */
    public io.grpc.coordinator.Coordinator.responserobotid coordinatorrobotreport(io.grpc.coordinator.Coordinator.requestrobotid request) {
  ...
  public static final class CoordinatorServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CoordinatorServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.coordinator.Coordinator.responserobotid> coordinatorrobotreport(
        io.grpc.coordinator.Coordinator.requestrobotid request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_COORDINATORROBOTREPORT:
          serviceImpl.coordinatorrobotreport((io.grpc.coordinator.Coordinator.requestrobotid) request,
              (io.grpc.stub.StreamObserver<io.grpc.coordinator.Coordinator.responserobotid>) responseObserver);
          break;
        default:
