...
/**
 * This class provides coordination for a fleet of robots. An instantiatable {@link RemoteTrajectoryEnvelopeCoordinator}
 ...
 *
 */
public abstract class RemoteTrajectoryEnvelopeCoordinator extends RemoteAbstractTrajectoryEnvelopeCoordinator {
    ...
    /**
     * Create a new {@link RemoteTrajectoryEnvelopeCoordinator}, with control period 1000 msec,
     * and temporal resolution 1000 (milliseconds).
     */
    public RemoteTrajectoryEnvelopeCoordinator() {
        this(1000, 1000.0);
    }

    /**
     * Create a new {@link RemoteTrajectoryEnvelopeCoordinator}, with given control period and temporal resolution.
     ...
     */
    public RemoteTrajectoryEnvelopeCoordinator(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION) {
    ...
    protected boolean getOrder(RemoteAbstractTrajectoryEnvelopeTracker robotTracker1, RobotReport robotReport1, RemoteAbstractTrajectoryEnvelopeTracker robotTracker2, RobotReport robotReport2, CriticalSection cs) {
        ...
        synchronized(solver) {
            ...
            synchronized(allCriticalSections) {
                ...
                for (CriticalSection cs : this.allCriticalSections) {
                    ...
                    if (robotTracker1 instanceof RemoteTrajectoryEnvelopeTrackerDummy || robotTracker2 instanceof RemoteTrajectoryEnvelopeTrackerDummy) {

                        boolean createAParkingDep = false;
                        this.isBlocked = true;

                        //Robot1 is parking in critical section. If it is the driver, make robot 2 wait.
                        if (robotTracker1 instanceof RemoteTrajectoryEnvelopeTrackerDummy) {
                        ...
                        else if (robotTracker2 instanceof RemoteTrajectoryEnvelopeTrackerDummy) {
    ...
    public boolean truncateEnvelope(int robotID, boolean ensureDynamicFeasibility) {
        ...
        synchronized (solver) {
            ...
            if (!(tet instanceof RemoteTrajectoryEnvelopeTrackerDummy)) {
            ...
            synchronized(allCriticalSections) {
                ...
                for (CriticalSection cs : reversibleCS) {
                    ...
                    if (robot2YieldsOld != robot2Yields) {
                        ...
                        RemoteAbstractTrajectoryEnvelopeTracker drivingTracker = robot2Yields ? robotTracker1 : robotTracker2;
                        RemoteAbstractTrajectoryEnvelopeTracker waitingTracker = robot2Yields ? robotTracker2 : robotTracker1;
