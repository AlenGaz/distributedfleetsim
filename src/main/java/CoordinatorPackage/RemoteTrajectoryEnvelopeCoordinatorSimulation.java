...
/*	*//**
	 ...
	 * </ul>
	 */
	public RemoteTrajectoryEnvelopeCoordinatorSimulation(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION, double MAX_VELOCITY, double MAX_ACCELERATION) {
	 ...
	 * </ul>
	 */
	public RemoteTrajectoryEnvelopeCoordinatorSimulation(double MAX_VELOCITY, double MAX_ACCELERATION) {
	...
	public TrajectoryEnvelopeTrackerLight getNewTracker(TrajectoryEnvelope te, TrackingCallback cb) {
		...
		TrajectoryEnvelopeTrackerLight ret = new TrajectoryEnvelopeTrackerLight(this, te, this.DEFAULT_ROBOT_TRACKING_PERIOD, TEMPORAL_RESOLUTION, cb, coordinatorServicImpl) {
...
*/
	...
	protected void updateDependencies() {
		synchronized(solver) {
			...
			System.out.println("{RemoteTrajectory..CoordinatorSimulation} trackers.keyset" + trackers.keySet());
