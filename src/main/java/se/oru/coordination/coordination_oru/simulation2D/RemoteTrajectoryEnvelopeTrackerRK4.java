...
public abstract class RemoteTrajectoryEnvelopeTrackerRK4 extends AbstractTrajectoryEnvelopeTracker implements Runnable {
	...
	public RemoteTrajectoryEnvelopeTrackerRK4(TrajectoryEnvelope te, int timeStep, double temporalResolution, RemoteTrajectoryEnvelopeCoordinatorSimulation tec, TrackingCallback cb) {
	...
	public RemoteTrajectoryEnvelopeTrackerRK4(TrajectoryEnvelope te, int timeStep, double temporalResolution, double maxVelocity, double maxAcceleration, TrajectoryEnvelopeCoordinator tec, TrackingCallback cb) {
	...
	public void setCriticalPoint(int criticalPointToSet, int extCPCounter) {
		...
		//System.out.println("In Rk4 printing dependencies" + tec.getCurrentDependencies());
	...
	public abstract HashSet<Dependency> getCurrentDependencies();
}
