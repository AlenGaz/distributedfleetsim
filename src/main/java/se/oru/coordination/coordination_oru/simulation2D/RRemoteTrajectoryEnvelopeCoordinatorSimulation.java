...
public class RRemoteTrajectoryEnvelopeCoordinatorSimulation extends TrajectoryEnvelopeCoordinator {
...
/**
    ...
    public RRemoteTrajectoryEnvelopeCoordinatorSimulation() {
...
/**
    ...
    public RRemoteTrajectoryEnvelopeCoordinatorSimulation(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION, double MAX_VELOCITY, double MAX_ACCELERATION) {
...
/**
    ...
    public RRemoteTrajectoryEnvelopeCoordinatorSimulation(double MAX_VELOCITY, double MAX_ACCELERATION) {
...
/**
    ...
    public RRemoteTrajectoryEnvelopeCoordinatorSimulation(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION) {
...
/**
    ...
    public RRemoteTrajectoryEnvelopeCoordinatorSimulation(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION, double MAX_VELOCITY, double MAX_ACCELERATION, int DEFAULT_ROBOT_TRACKING_PERIOD) {
...
/**
    ...
    public AbstractTrajectoryEnvelopeTracker getNewTracker(TrajectoryEnvelope te, TrackingCallback cb) {
        RRemoteTrajectoryEnvelopeTrackerRK4 ret = new RRemoteTrajectoryEnvelopeTrackerRK4(te, this.getRobotTrackingPeriodInMillis(te.getRobotID()), TEMPORAL_RESOLUTION, MAX_VELOCITY, MAX_ACCELERATION, this, cb) {
