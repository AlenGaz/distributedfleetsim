...
//	public RemoteTrajectoryEnvelopeCoordinatorSimulationICAPS(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION, double MAX_VELOCITY, double MAX_ACCELERATION, String logFile, String logHeading, ArrayList<Integer> robotsInUse) {
