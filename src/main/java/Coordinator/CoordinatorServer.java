...
import GRPC.CoordinatorService;
 ...
 *
 */
public class CoordinatorServer extends AbstractTrajectoryEnvelopeCoordinator {
     ...
     */
    public CoordinatorServer(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION) {
